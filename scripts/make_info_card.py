...
ROWS = [
    ...
    ('kv', 'Current', 'Final year B.Tech Student'),
    ('kv', 'Focus', 'Full-Stack Development + AI/ML'),
    ('kv', 'Learning', 'DSA, System Design, AI/ML'),
    ('kv', 'Education', 'B.Tech, MITS-DU,gwl'),

    ('gap',),

    ('sec', 'Stack'),
    ('kv', 'Languages', 'Python, JavaScript, TypeScript, C++,Java'),
    ('kv', 'Frontend', 'React, Next.js, Tailwind CSS, GSAP'),
    ('kv', 'Backend', 'Node.js, Express, Django'),
    ('kv', 'Database', 'MongoDB, PostgreSQL, MySQL, Prisma'),
    ('kv', 'AI / ML', 'currently working on DL, RAG, LangChain'),
    ('kv', 'Tools', 'Git, Docker, AWS/Vercel, Github Actions'),

    ('gap',),

    ('sec', 'Highlights'),
    ('bul', 'Building STAYZ - a modern way to find your stayz'),
    ('bul', 'Made DraftSpace - An AI powered WhiteBoard with live collaboration'),
    ('bul', 'Made Ikigai4Teens - A Career counselling AI based on IKIGAI principles'),
]
...
for i, row in enumerate(ROWS):
    ...
    if kind == "host":
        inner = (f'<text x="{KEY_X}" y="{y:.1f}" font-size="14" font-weight="700">'
                 ...
                 f'<tspan fill="{ACCENT}">dev</tspan></text>'
